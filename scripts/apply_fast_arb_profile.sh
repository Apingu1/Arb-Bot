...
echo "Applied Phase 1.7 fast-arbitrage research profile to $ENV_FILE"
echo
grep -E '^(MIN_NET_EDGE_PER_SHARE|MIN_EXPECTED_PROFIT_USDC|MIN_TRADE_SHARES|MAX_TRADE_SHARES|SHADOW_LATENCY_MS|DUAL_FOK_BASE_LATENCY_MS|DUAL_FOK_PRIMARY_SIZE|DUAL_FOK_PRIMARY_EDGE_TARGET|DUAL_FOK_PRIMARY_SKEW_MS|DUAL_FOK_PRIMARY_STABILITY_MS|DUAL_FOK_SKEWS_MS|DUAL_FOK_EDGE_TARGETS)=' "$ENV_FILE"
